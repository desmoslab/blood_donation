            ...
            Container(
              ...
              child: Stack(
                ...
                children: [
                  ...
                  SvgPicture.asset('assets/images/Donate to others.svg',)
                  /*Image(
                ...
                Align(
                  ...
                  child: Container(
                    //  width: getDeviceWidthByPercentage(70, context),
                      ...
                      child: buildText("Donate to others",  fontSize: 20, maxLine: 2,fontWeight: FontWeight.bold,fontFamily: customFontFamily.Lato.toShortString() )
                  ),
                ),
                Align(
                  alignment: AlignmentDirectional.topStart,
                  child: Padding(
                      padding:  EdgeInsets.only(left: getDeviceWidthByPercentage(20, context), right: getDeviceWidthByPercentage(20, context), top: getDeviceHeightByPercentage(2, context)),
                      child: buildText("Blood donation is a voluntary procedure that can help save the lives of others. There are several types of blood donation. Each type helps meet different medical needs.", fontSize: 16, maxLine: 5,fontFamily: customFontFamily.PlayfairDisplay.toShortString() )
                  ),
                ),
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          style: ButtonStyle(
                            foregroundColor: MaterialStateProperty.all<Color>(Colors.black),
                            backgroundColor: MaterialStateProperty.all<Color>(Colors.white),
                            padding: MaterialStateProperty.all(EdgeInsets.only(left:45,top: 12,bottom: 12,right: 30)),
                            textStyle: MaterialStateProperty.all(TextStyle(fontSize: 18)) ,
                            shape: MaterialStateProperty.all<RoundedRectangleBorder>(
                              RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(12.0),
