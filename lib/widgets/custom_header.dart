        ...
        children: [
          Row(
            children: [
              ...
              Padding(
                  padding: EdgeInsets.only(left: getDeviceWidthByPercentage(2.5, context) ),
                  child:buildText(widget.title,fontFamily: customFontFamily.PlayfairDisplay.toShortString(), fontSize: 13, fontColor: Colors.white, fontWeight: FontWeight.w600 )
              ),
            ],
          ),
