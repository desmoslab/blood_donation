...
import 'package:blood_donation/onBoardingScreen4.dart';
              ...
              child: Stack(
                ...
                children: [
                  ...
                  /*Image(
                    ...
                    image: AssetImage('assets/images/find_donor.jpeg'),
                  ),*/
                ...
                Align(
                  ...
                  child: Container(
                    //  width: getDeviceWidthByPercentage(70, context),
                      ...
                      child: buildText("Find Donors",  fontSize: 20, maxLine: 2,fontWeight: FontWeight.bold,fontFamily: customFontFamily.Lato.toShortString() )
                  ),
                ),
                Align(
                  alignment: AlignmentDirectional.topStart,
                  child: Padding(
                      padding:  EdgeInsets.only(left: getDeviceWidthByPercentage(10, context), right: getDeviceWidthByPercentage(10, context), top: getDeviceHeightByPercentage(2, context)),
                      child: buildText(" Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document.", fontSize: 18, maxLine: 5,fontFamily: customFontFamily.PlayfairDisplay.toShortString() )
                  ),
                ),
                        ...
                        child: ElevatedButton(
                          ...
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => OnboardingScreenFour(),
                              ),
                            );
                          },
                        ),
